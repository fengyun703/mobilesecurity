...
public class SettingActivity extends Activity {
	...
	private static final String[] items = new String[]{"蓝色", "灰色","绿色","橘黄","白色"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		init(siv_blacknumber, "com.mobilesecurity.services.BlackNumberService", BlackNumberService.class);
		/*if(ServiceStateUtils.isRunning(SettingActivity.this, "com.mobilesecurity.services.BlackNumberService")){
		...
		init(siv_address_setting, "com.mobilesecurity.services.AddressQureyService", AddressQureyService.class);
		
		/*if(ServiceStateUtils.isRunning(SettingActivity.this, "com.mobilesecurity.services.AddressQureyService")){
		...
		siv_address_setting.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(siv_address_setting.isChecked()){
					siv_address_setting.setChecked(false);
					//System.out.println("关闭服务！"); 
					Intent service = new Intent(SettingActivity.this, AddressQureyService.class);
					stopService(service);
				}else{
					siv_address_setting.setChecked(true);
					//System.out.println("开启服务！");  
	...
	private void init(final SettingItemView siv, String className,
			final Class<?> cls) {
		if(ServiceStateUtils.isRunning(SettingActivity.this, className)){
			siv.setChecked(true);
			//System.out.println("服务已经开启了！");
		}else{
		...
		siv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(siv.isChecked()){
					siv.setChecked(false);
					//System.out.println("关闭服务！"); 
					Intent service = new Intent(SettingActivity.this, cls);
					stopService(service);
				}else{
					siv.setChecked(true);
					//System.out.println("开启服务！");  
	...
	public void setbackgroud(View view){
		...
		//private static int[] icons = {R.drawable.call_locate_blue, R.drawable.call_locate_gray, R.drawable.call_locate_green,
		//	R.drawable.call_locate_orange, R.drawable.call_locate_white};
		builder.setSingleChoiceItems(items, sp.getInt("color", 1), new DialogInterface.OnClickListener() {
